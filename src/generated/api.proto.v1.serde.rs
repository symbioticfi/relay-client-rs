...
impl serde::Serialize for GetAggregationProofsByEpochRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("api.proto.v1.GetAggregationProofsByEpochRequest", len)?;
        if self.epoch != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for GetAggregationProofsByEpochRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetAggregationProofsByEpochRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct api.proto.v1.GetAggregationProofsByEpochRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetAggregationProofsByEpochRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(GetAggregationProofsByEpochRequest {
                    epoch: epoch__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("api.proto.v1.GetAggregationProofsByEpochRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetAggregationProofsByEpochResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let mut len = 0;
        if !self.aggregation_proofs.is_empty() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("api.proto.v1.GetAggregationProofsByEpochResponse", len)?;
        if !self.aggregation_proofs.is_empty() {
            struct_ser.serialize_field("aggregationProofs", &self.aggregation_proofs)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GetAggregationProofsByEpochResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "aggregationProofs" | "aggregation_proofs" => Ok(GeneratedField::AggregationProofs),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetAggregationProofsByEpochResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct api.proto.v1.GetAggregationProofsByEpochResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetAggregationProofsByEpochResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut aggregation_proofs__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::AggregationProofs => {
                            if aggregation_proofs__.is_some() {
                                return Err(serde::de::Error::duplicate_field("aggregationProofs"));
                            }
                            aggregation_proofs__ = Some(map_.next_value()?);
                        }
                    }
                }
                Ok(GetAggregationProofsByEpochResponse {
                    aggregation_proofs: aggregation_proofs__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("api.proto.v1.GetAggregationProofsByEpochResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for GetCustomScheduleNodeStatusRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        if self.max_participants_per_slot != 0 {
            len += 1;
        }
        if self.min_participants_per_slot != 0 {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("api.proto.v1.GetCustomScheduleNodeStatusRequest", len)?;
        ...
        if let Some(v) = self.seed.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("seed", pbjson::private::base64::encode(&v).as_str())?;
        }
        if self.slot_duration_seconds != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("slotDurationSeconds", ToString::to_string(&self.slot_duration_seconds).as_str())?;
        }
        if self.max_participants_per_slot != 0 {
            struct_ser.serialize_field("maxParticipantsPerSlot", &self.max_participants_per_slot)?;
        }
        if self.min_participants_per_slot != 0 {
            struct_ser.serialize_field("minParticipantsPerSlot", &self.min_participants_per_slot)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GetCustomScheduleNodeStatusRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        const FIELDS: &[&str] = &[
            ...
            "min_participants_per_slot",
            "minParticipantsPerSlot",
        ];
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "slotDurationSeconds" | "slot_duration_seconds" => Ok(GeneratedField::SlotDurationSeconds),
                            "maxParticipantsPerSlot" | "max_participants_per_slot" => Ok(GeneratedField::MaxParticipantsPerSlot),
                            "minParticipantsPerSlot" | "min_participants_per_slot" => Ok(GeneratedField::MinParticipantsPerSlot),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetCustomScheduleNodeStatusRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct api.proto.v1.GetCustomScheduleNodeStatusRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetCustomScheduleNodeStatusRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut epoch__ = None;
                let mut seed__ = None;
                let mut slot_duration_seconds__ = None;
                let mut max_participants_per_slot__ = None;
                let mut min_participants_per_slot__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Epoch => {
                            if epoch__.is_some() {
                        ...
                        GeneratedField::SlotDurationSeconds => {
                            if slot_duration_seconds__.is_some() {
                                return Err(serde::de::Error::duplicate_field("slotDurationSeconds"));
                            }
                            slot_duration_seconds__ = 
                                Some(map_.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0)
                            ;
                        }
                        GeneratedField::MaxParticipantsPerSlot => {
                            if max_participants_per_slot__.is_some() {
                                return Err(serde::de::Error::duplicate_field("maxParticipantsPerSlot"));
                            }
                            max_participants_per_slot__ = 
                                Some(map_.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0)
                            ;
                        }
                        GeneratedField::MinParticipantsPerSlot => {
                            if min_participants_per_slot__.is_some() {
                                return Err(serde::de::Error::duplicate_field("minParticipantsPerSlot"));
                            }
                            min_participants_per_slot__ = 
                                Some(map_.next_value::<::pbjson::private::NumberDeserialize<_>>()?.0)
                            ;
                        }
                    }
                }
                Ok(GetCustomScheduleNodeStatusRequest {
                    epoch: epoch__,
                    seed: seed__,
                    slot_duration_seconds: slot_duration_seconds__.unwrap_or_default(),
                    max_participants_per_slot: max_participants_per_slot__.unwrap_or_default(),
                    min_participants_per_slot: min_participants_per_slot__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("api.proto.v1.GetCustomScheduleNodeStatusRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetCustomScheduleNodeStatusResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
...
impl<'de> serde::Deserialize<'de> for GetCustomScheduleNodeStatusResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetCustomScheduleNodeStatusResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct api.proto.v1.GetCustomScheduleNodeStatusResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetCustomScheduleNodeStatusResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("api.proto.v1.GetCustomScheduleNodeStatusResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for GetLocalValidatorRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("api.proto.v1.GetLocalValidatorRequest", len)?;
        if let Some(v) = self.epoch.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("epoch", ToString::to_string(&v).as_str())?;
...
impl<'de> serde::Deserialize<'de> for GetLocalValidatorRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetLocalValidatorRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct api.proto.v1.GetLocalValidatorRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetLocalValidatorRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut epoch__ = None;
                ...
                Ok(GetLocalValidatorRequest {
                    epoch: epoch__,
                })
            }
        }
        deserializer.deserialize_struct("api.proto.v1.GetLocalValidatorRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetLocalValidatorResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("api.proto.v1.GetLocalValidatorResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for GetLocalValidatorResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetLocalValidatorResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct api.proto.v1.GetLocalValidatorResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetLocalValidatorResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(GetLocalValidatorResponse {
                    validator: validator__,
                })
            }
        }
        deserializer.deserialize_struct("api.proto.v1.GetLocalValidatorResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetSignatureRequestIDsByEpochRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("api.proto.v1.GetSignatureRequestIDsByEpochRequest", len)?;
        if self.epoch != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("epoch", ToString::to_string(&self.epoch).as_str())?;
...
impl<'de> serde::Deserialize<'de> for GetSignatureRequestIDsByEpochRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetSignatureRequestIDsByEpochRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct api.proto.v1.GetSignatureRequestIDsByEpochRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetSignatureRequestIDsByEpochRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut epoch__ = None;
                ...
                Ok(GetSignatureRequestIDsByEpochRequest {
                    epoch: epoch__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("api.proto.v1.GetSignatureRequestIDsByEpochRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetSignatureRequestIDsByEpochResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("api.proto.v1.GetSignatureRequestIDsByEpochResponse", len)?;
        if !self.request_ids.is_empty() {
            struct_ser.serialize_field("requestIds", &self.request_ids)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GetSignatureRequestIDsByEpochResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "requestIds" | "request_ids" => Ok(GeneratedField::RequestIds),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetSignatureRequestIDsByEpochResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct api.proto.v1.GetSignatureRequestIDsByEpochResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetSignatureRequestIDsByEpochResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut request_ids__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::RequestIds => {
                            if request_ids__.is_some() {
                                return Err(serde::de::Error::duplicate_field("requestIds"));
                            }
                            request_ids__ = Some(map_.next_value()?);
                        }
                    }
                }
                Ok(GetSignatureRequestIDsByEpochResponse {
                    request_ids: request_ids__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("api.proto.v1.GetSignatureRequestIDsByEpochResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for GetSignatureRequestResponse {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let mut len = 0;
        if self.signature_request.is_some() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("api.proto.v1.GetSignatureRequestResponse", len)?;
        if let Some(v) = self.signature_request.as_ref() {
            struct_ser.serialize_field("signatureRequest", v)?;
        }
        struct_ser.end()
    }
}
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "signatureRequest" | "signature_request" => Ok(GeneratedField::SignatureRequest),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetSignatureRequestResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut signature_request__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::SignatureRequest => {
                            if signature_request__.is_some() {
                                return Err(serde::de::Error::duplicate_field("signatureRequest"));
                            }
                            signature_request__ = map_.next_value()?;
                        }
                    }
                }
                Ok(GetSignatureRequestResponse {
                    signature_request: signature_request__,
                })
            }
        }
...
impl serde::Serialize for GetSignatureRequestsByEpochRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("api.proto.v1.GetSignatureRequestsByEpochRequest", len)?;
        if self.epoch != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("epoch", ToString::to_string(&self.epoch).as_str())?;
...
impl<'de> serde::Deserialize<'de> for GetSignatureRequestsByEpochRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetSignatureRequestsByEpochRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct api.proto.v1.GetSignatureRequestsByEpochRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetSignatureRequestsByEpochRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut epoch__ = None;
                ...
                Ok(GetSignatureRequestsByEpochRequest {
                    epoch: epoch__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("api.proto.v1.GetSignatureRequestsByEpochRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetSignatureRequestsByEpochResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("api.proto.v1.GetSignatureRequestsByEpochResponse", len)?;
        if !self.signature_requests.is_empty() {
            struct_ser.serialize_field("signatureRequests", &self.signature_requests)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GetSignatureRequestsByEpochResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "signatureRequests" | "signature_requests" => Ok(GeneratedField::SignatureRequests),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetSignatureRequestsByEpochResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct api.proto.v1.GetSignatureRequestsByEpochResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetSignatureRequestsByEpochResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut signature_requests__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::SignatureRequests => {
                            if signature_requests__.is_some() {
                                return Err(serde::de::Error::duplicate_field("signatureRequests"));
                            }
                            signature_requests__ = Some(map_.next_value()?);
                        }
                    }
                }
                Ok(GetSignatureRequestsByEpochResponse {
                    signature_requests: signature_requests__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("api.proto.v1.GetSignatureRequestsByEpochResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetSignaturesByEpochRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("api.proto.v1.GetSignaturesByEpochRequest", len)?;
        if self.epoch != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("epoch", ToString::to_string(&self.epoch).as_str())?;
...
impl<'de> serde::Deserialize<'de> for GetSignaturesByEpochRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetSignaturesByEpochRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct api.proto.v1.GetSignaturesByEpochRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetSignaturesByEpochRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut epoch__ = None;
                ...
                Ok(GetSignaturesByEpochRequest {
                    epoch: epoch__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("api.proto.v1.GetSignaturesByEpochRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetSignaturesByEpochResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("api.proto.v1.GetSignaturesByEpochResponse", len)?;
        if !self.signatures.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GetSignaturesByEpochResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetSignaturesByEpochResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct api.proto.v1.GetSignaturesByEpochResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetSignaturesByEpochResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(GetSignaturesByEpochResponse {
                    signatures: signatures__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("api.proto.v1.GetSignaturesByEpochResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for GetValidatorByKeyRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        if !self.on_chain_key.is_empty() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("api.proto.v1.GetValidatorByKeyRequest", len)?;
        if let Some(v) = self.epoch.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("epoch", ToString::to_string(&v).as_str())?;
        ...
        if !self.on_chain_key.is_empty() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("onChainKey", pbjson::private::base64::encode(&self.on_chain_key).as_str())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GetValidatorByKeyRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "onChainKey" | "on_chain_key" => Ok(GeneratedField::OnChainKey),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetValidatorByKeyRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct api.proto.v1.GetValidatorByKeyRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetValidatorByKeyRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut epoch__ = None;
                let mut key_tag__ = None;
                let mut on_chain_key__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Epoch => {
                            if epoch__.is_some() {
                        ...
                        GeneratedField::OnChainKey => {
                            if on_chain_key__.is_some() {
                                return Err(serde::de::Error::duplicate_field("onChainKey"));
                            }
                            on_chain_key__ = 
                                Some(map_.next_value::<::pbjson::private::BytesDeserialize<_>>()?.0)
                            ;
                ...
                Ok(GetValidatorByKeyRequest {
                    epoch: epoch__,
                    key_tag: key_tag__.unwrap_or_default(),
                    on_chain_key: on_chain_key__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("api.proto.v1.GetValidatorByKeyRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetValidatorByKeyResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("api.proto.v1.GetValidatorByKeyResponse", len)?;
        if let Some(v) = self.validator.as_ref() {
            struct_ser.serialize_field("validator", v)?;
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for GetValidatorByKeyResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetValidatorByKeyResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct api.proto.v1.GetValidatorByKeyResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetValidatorByKeyResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut validator__ = None;
                ...
                Ok(GetValidatorByKeyResponse {
                    validator: validator__,
                })
            }
        }
        deserializer.deserialize_struct("api.proto.v1.GetValidatorByKeyResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for SignatureRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("api.proto.v1.SignatureRequest", len)?;
        if !self.request_id.is_empty() {
            struct_ser.serialize_field("requestId", &self.request_id)?;
        }
        if self.key_tag != 0 {
...
impl<'de> serde::Deserialize<'de> for SignatureRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct api.proto.v1.SignatureRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SignatureRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut request_id__ = None;
        ...
        deserializer.deserialize_struct("api.proto.v1.SignatureRequest", FIELDS, GeneratedVisitor)
    }
}
